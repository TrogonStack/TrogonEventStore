...
If you read the data of a redacted event from an external client, you should see data composed of only 0xFF bytes. The Razor Admin UI will also label redacted events.
