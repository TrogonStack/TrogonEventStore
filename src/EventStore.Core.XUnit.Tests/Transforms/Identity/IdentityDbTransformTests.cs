...
public class IdentityDbTransformTests
{
	...
	[Fact]
	public void chunk_factory_has_correct_type() =>
		Assert.Equal(TransformType.Identity, _dbTransform.ChunkFactory.Type);

	[Fact]
	public void chunk_factory_provides_correct_header_length() =>
