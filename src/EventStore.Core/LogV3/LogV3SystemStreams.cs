	...
	: ISystemStreamLookup<StreamId>
{
	...
	{
		if (IsVirtualStream(streamId) ||
		    metastreams.IsMetaStream(streamId) ||
	...
	public bool IsMetaStream(StreamId streamId) => metastreams.IsMetaStream(streamId);

	public StreamId MetaStreamOf(StreamId streamId) => metastreams.MetaStreamOf(streamId);

	public StreamId OriginalStreamOf(StreamId streamId) => metastreams.OriginalStreamOf(streamId);
}
