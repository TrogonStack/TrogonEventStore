...
internal sealed class MacOSCertificateManager : CertificateManager
{
	...
	private const string MacOSFindCertificateCommandLineArgumentsFormat =
	...
	private const string MacOSTrustCertificateCommandLineArguments =
	...
	public override bool IsTrusted(X509Certificate2 certificate)
	{
		...
		var matches = Regex.Matches(output, MacOSFindCertificateOutputRegex, RegexOptions.Multiline,
			MaxRegexTimeout);
