	...
	ReadIndexTestScenario<TLogFormat, TStreamId>
{
	...
	public async Task return_correct_last_event_version_for_first_stream()
	{
		Assert.AreEqual(EventNumber.DeletedStream,
			await ReadIndex.GetStreamLastEventNumber("AB", CancellationToken.None));
	}

	[Test]
	public async Task not_find_log_record_for_first_stream()
	{
	...
	[Test]
	public async Task return_empty_range_on_from_start_range_query_for_first_stream()
	{
	...
	[Test]
	public async Task return_empty_range_on_from_end_range_query_for_first_stream()
	{
