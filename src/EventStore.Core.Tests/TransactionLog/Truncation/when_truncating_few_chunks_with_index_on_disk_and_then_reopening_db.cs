...
public class when_truncating_few_chunks_with_index_on_disk_and_then_reopening_db<TLogFormat, TStreamId>()
	: TruncateAndReOpenDbScenario<TLogFormat, TStreamId>(maxEntriesInMemTable: 3)
{
